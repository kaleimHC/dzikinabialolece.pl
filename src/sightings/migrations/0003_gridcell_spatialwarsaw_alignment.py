...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.FloatField(
                default=0,
                help_text='Final risk score 0-1'
            ),
        ),
        migrations.AddField(
            model_name='gridcell',
        ...
        migrations.AddField(
            ...
            field=models.FloatField(
                default=0,
                help_text='GWR prediction score'
            ),
        ),
        migrations.AddField(
            model_name='gridcell',
        ...
        migrations.AddIndex(
            model_name='gridcell',
            index=models.Index(fields=['ensemble_risk'], name='sightings_g_ensembl_idx'),
        ),
    ]
