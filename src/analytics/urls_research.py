...
urlpatterns = [
    ...
    path('configs/<int:config_id>/', views.config_detail, name='research-config-detail'),
    path('configs/<int:config_id>/activate/', views.config_activate, name='research-config-activate'),
    ...
    path('runs/<uuid:run_id>/diagnostics/', views.run_diagnostics, name='research-run-diagnostics'),
