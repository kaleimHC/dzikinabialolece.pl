...
class ModelPrediction(models.Model):
    ...
    prediction_date = models.DateField(
        help_text='Date this prediction is valid for'
    )
    ...
    local_r_squared = models.FloatField(
        ...
        help_text='Local R² from GWR'
    )
    bandwidth = models.FloatField(
        null=True, blank=True,
        help_text='GWR bandwidth in meters'
    )
...
from .models_research import ResearchConfig, ResearchRun, ResearchStepLog, ResearchDiagnostics
