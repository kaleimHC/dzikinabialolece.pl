...
urlpatterns = [
    ...
    path('research-grid/', views.research_grid_cells, name='research-grid-cells'),  # RESEARCH mode (voronoi)
    path('research-grid-500/', views.research_grid_500, name='research-grid-500'),  # RESEARCH mode (500m)
    path('voronoi/features/', views.calculate_voronoi_features, name='voronoi-features'),
    ...
    path('tasks/<str:task_id>/status/', views.sample_task_progress, name='sample-task-progress'),
    ...
    path('bayesian/diagnostics/', views.bayesian_diagnostics, name='bayesian-diagnostics'),
    ...
    path('pipeline/<str:task_id>/status/', views.pipeline_status, name='pipeline-status'),
]
