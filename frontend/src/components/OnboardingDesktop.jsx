...
const TARGETS = [
  {
    ...
    body: <>Lasy, woda, zabudowa, drogi<br />- włącz kontekst środowiskowy<br />na tle danych obserwacji.</>,
  ...
  },
  {
    ...
    body: <>Wybierz algorytm (fastPython, voronoiGrids, spatialWarsaw)<br />i przelicz - wynik pojawia się na mapie.</>,
...
function FooterStrip({ onDismiss }) {
  return (
    <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 502 }}>
    <motion.div
    ...
    >
      ...
      <span style={{ fontSize: '12px', color: '#fff', fontWeight: 600, whiteSpace: 'nowrap' }}>
