        ...
        return (
          <button
            ...
            style={{
              ...
              padding: '6px 8px',
              borderRadius: '6px',
              backgroundColor: isActive ? color : 'rgb(var(--color-gray-700) / 0.8)',
          ...
          >
            ...
            <div
              style={{
                ...
                height: '12px',
                borderRadius: '3px',
                backgroundColor: isActive ? 'rgba(255,255,255,0.3)' : 'rgb(var(--color-gray-600))',
...
export default function LayerToggles({ isExpanded = false, onToggle, bare = false, columns = 2 }) {
