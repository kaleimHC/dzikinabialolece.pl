...
export default function ReportSheet() {
  const { isAddMode, pendingLocation, exitAddMode, submitSighting, isLoading } = useSightingsStore();
        ...
        >
          <div style={{
            ...
            <motion.button
              ...
              animate={{
                background: type === 'encounter' ? tk.encounter : 'rgb(var(--color-gray-700) / 0.5)',
                color: type === 'encounter' ? 'white' : 'rgb(var(--color-muted))'
              }}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              animate={{ 
                background: type === 'ryjowisko' ? tk.ryjowisko : 'rgb(var(--color-gray-700) / 0.5)',
                color: type === 'ryjowisko' ? 'white' : 'rgb(var(--color-muted))'
              }}
              transition={{ duration: 0.2 }}
              style={{
                flex: 1,
