      ...
      map.addLayer({
        ...
        paint: {
          "fill-color": [
            "interpolate",
            ["linear"],
            ["get", "prob_above_threshold"],
            0,
            tk.heatmap.bayesian.s0,
            0.3,
            tk.heatmap.bayesian.s1,
            0.5,
            tk.heatmap.bayesian.s2,
            0.7,
            tk.heatmap.bayesian.s3,
            1,
            tk.heatmap.bayesian.s4,
          ],
  ...
  useEffect(() => {
    ...
    const handleLayerToggle = (e) => {
      ...
      if (layer === "highRiskOnly") {
        ...
        if (map.getLayer("bayesian-heatmap")) {
          if (visible) {
            map.setFilter("bayesian-heatmap", [
              ">",
              ["get", "prob_above_threshold"],
              0.7,
            ]);
