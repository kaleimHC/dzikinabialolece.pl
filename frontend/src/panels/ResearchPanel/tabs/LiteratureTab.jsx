...
const LECTURES = [
  ...
  },
  {
    ...
    rejected:
      "Pełen BootSpatReg() pipeline – wymaga próby min. 50K obserwacji do sensownego resampligu subpróby. Nasz PUB mode (~870 cells) lub FAST mode (9875 cells) — bootstrap subsampling teoretycznie możliwy ale wymaga min. 50K obserwacji dla sensownego resamplingu per BootSpatReg() spec. Out of current portfolio scope.",
    inCode:
      "r_scripts/05_ensemble_prediction.R:146-154 (wagi ensemble: W_DENSITY=0.30, W_SPATIAL=0.40, W_ETA=0.30)",
  },
  {
