...
const PACKAGES = [
  {
    type: "package",
    authors: "Kopyt, M., Kopczewska, K., Kubara, M., Dobrowolska, E.",
    year: null,
    title:
...
const SectionHeader = ({ sectionId, count }) => {
  const cfg = {
    ...
    packages: {
      title: "Pakiety R",
      desc: "Biblioteki R i narzędzia analityczne. Aktywnie importowane w przepływie: spdep, spatialreg, RPostgres, sf i inne. Inspiracja metodologiczna (zainstalowane w Dockerfile.r jako CONCEPT REF, bez library() w skryptach R): spatialWarsaw - koncepty zaadoptowane i zaimplementowane własnoręcznie.",
    },
  };
