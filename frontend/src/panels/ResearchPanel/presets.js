...
export const RESEARCH_PRESETS = {
  ...
  "RES-24": {
    ...
    group: "Voronoi",
    description:
      "Voronoi z macierzą sąsiedztwa tessW: nasz wariant ważony długością wspólnej granicy (tessW w spatialWarsaw to binarna przyległość poly2nb/nb2listw - ważenie to nasza adaptacja). Lepsza dla nieregularnych komórek.",
    config: {
      geometry_type: "voronoi",
      population_method: "points",
      y_formula: "inv_pop",
